ALTER TABLE SBBD_SIT.ACCASHPOST2021
 DROP PRIMARY KEY CASCADE;

DROP TABLE SBBD_SIT.ACCASHPOST2021 CASCADE CONSTRAINTS;

CREATE TABLE SBBD_SIT.ACCASHPOST2021
(
...
ALTER TABLE SBBD_SIT.ACCASHSUM2021
 DROP PRIMARY KEY CASCADE;

DROP TABLE SBBD_SIT.ACCASHSUM2021 CASCADE CONSTRAINTS;

CREATE TABLE SBBD_SIT.ACCASHSUM2021
(
...
DROP TABLE SBBD_SIT.AUDITLOG2021 CASCADE CONSTRAINTS;

CREATE TABLE SBBD_SIT.AUDITLOG2021
(
...
ALTER TABLE SBBD_SIT.CTRAN2021
 DROP PRIMARY KEY CASCADE;

DROP TABLE SBBD_SIT.CTRAN2021 CASCADE CONSTRAINTS;
...
ALTER TABLE SBBD_SIT.CTRANDD2021
 DROP PRIMARY KEY CASCADE;

DROP TABLE SBBD_SIT.CTRANDD2021 CASCADE CONSTRAINTS;

CREATE TABLE SBBD_SIT.CTRANDD2021
(
...
ALTER TABLE SBBD_SIT.GLSUM2021
 DROP PRIMARY KEY CASCADE;

DROP TABLE SBBD_SIT.GLSUM2021 CASCADE CONSTRAINTS;

CREATE TABLE SBBD_SIT.GLSUM2021
(
...
DROP TABLE SBBD_SIT.OPRLOG2021 CASCADE CONSTRAINTS;

CREATE TABLE SBBD_SIT.OPRLOG2021
(
...
ALTER TABLE SBBD_SIT.SEGGLASUM2021
 DROP PRIMARY KEY CASCADE;

DROP TABLE SBBD_SIT.SEGGLASUM2021 CASCADE CONSTRAINTS;

CREATE TABLE SBBD_SIT.SEGGLASUM2021
(
...
ALTER TABLE SBBD_SIT.SEGREPTRAN2021
 DROP PRIMARY KEY CASCADE;

DROP TABLE SBBD_SIT.SEGREPTRAN2021 CASCADE CONSTRAINTS;

CREATE TABLE SBBD_SIT.SEGREPTRAN2021
(
...
ALTER TABLE SBBD_SIT.TRAN2021
 DROP PRIMARY KEY CASCADE;

DROP TABLE SBBD_SIT.TRAN2021 CASCADE CONSTRAINTS;
...
ALTER TABLE SBBD_SIT.TRANADV2021
 DROP PRIMARY KEY CASCADE;

DROP TABLE SBBD_SIT.TRANADV2021 CASCADE CONSTRAINTS;

CREATE TABLE SBBD_SIT.TRANADV2021
(
...
ALTER TABLE SBBD_SIT.TRANADVADDN2021
 DROP PRIMARY KEY CASCADE;

DROP TABLE SBBD_SIT.TRANADVADDN2021 CASCADE CONSTRAINTS;

CREATE TABLE SBBD_SIT.TRANADVADDN2021
(
...
ALTER TABLE SBBD_SIT.TRANBAT2021
 DROP PRIMARY KEY CASCADE;

DROP TABLE SBBD_SIT.TRANBAT2021 CASCADE CONSTRAINTS;
...
CREATE INDEX SBBD_SIT.IDX_AUDITLOG2021 ON SBBD_SIT.AUDITLOG2021
...
CREATE UNIQUE INDEX SBBD_SIT.IDX_CTRAN2021 ON SBBD_SIT.CTRAN2021
...
CREATE INDEX SBBD_SIT.IDX_OPRLOG2021 ON SBBD_SIT.OPRLOG2021
...
CREATE INDEX SBBD_SIT.IDX_TRAN2021_ACTNUM_DATE ON SBBD_SIT.TRAN2021
...
CREATE INDEX SBBD_SIT.IDX_TRAN2021_GL_ACBRN_ENTITY ON SBBD_SIT.TRAN2021
...
CREATE INDEX SBBD_SIT.IDX_TRAN2021_NOTICE_REFNO ON SBBD_SIT.TRAN2021
(TRAN_NOTICE_REF_NUM)
LOGGING
TABLESPACE TBFES
PCTFREE    10
...
CREATE UNIQUE INDEX SBBD_SIT.IDX_TRAN2021_PK ON SBBD_SIT.TRAN2021
...
CREATE UNIQUE INDEX SBBD_SIT.IDX_TRANBAT2021_PK ON SBBD_SIT.TRANBAT2021
...
--  There is no statement for index SBBD_SIT.SYS_C001870658.
--  The object is created when the parent object is created.

--  There is no statement for index SBBD_SIT.SYS_C001871283.
--  The object is created when the parent object is created.

--  There is no statement for index SBBD_SIT.SYS_C001871906.
--  The object is created when the parent object is created.

--  There is no statement for index SBBD_SIT.SYS_C001872647.
--  The object is created when the parent object is created.

--  There is no statement for index SBBD_SIT.SYS_C001872880.
--  The object is created when the parent object is created.

--  There is no statement for index SBBD_SIT.SYS_C001873128.
--  The object is created when the parent object is created.

--  There is no statement for index SBBD_SIT.SYS_C001874500.
--  The object is created when the parent object is created.

--  There is no statement for index SBBD_SIT.SYS_C001874530.
--  The object is created when the parent object is created.

CREATE OR REPLACE TRIGGER SBBD_IUT_DF.TRIG_CTRAN_LOG_2021 
   BEFORE INSERT OR UPDATE OR DELETE
   ON SBBD_SIT.CTRAN2021
   FOR EACH ROW
DECLARE
...
CREATE OR REPLACE TRIGGER SBBD_SIT.TRIG_CTRAN_LOG_2021
   BEFORE INSERT OR UPDATE OR DELETE
   ON SBBD_SIT.CTRAN2021
   FOR EACH ROW
DISABLE
...
CREATE OR REPLACE SYNONYM SBBD_SIT.CTRAN FOR SBBD_SIT.CTRAN2021;


CREATE OR REPLACE SYNONYM SBBD_SIT.CTRANDD FOR SBBD_SIT.CTRANDD2021;


CREATE OR REPLACE SYNONYM SBBD_SIT.TRAN FOR SBBD_SIT.TRAN2021;


CREATE OR REPLACE SYNONYM SBBD_SIT.TRANBAT FOR SBBD_SIT.TRANBAT2021;


ALTER TABLE SBBD_SIT.ACCASHPOST2021 ADD (
  PRIMARY KEY
...
ALTER TABLE SBBD_SIT.ACCASHSUM2021 ADD (
  PRIMARY KEY
...
ALTER TABLE SBBD_SIT.CTRAN2021 ADD (
  CONSTRAINT IDX_CTRAN2021
  PRIMARY KEY
  (CTRAN_ENTITY_NUM, CT_BRN_CODE, CT_TRAN_DATE, CT_CASHIER_ID, CT_DAY_SL)
  USING INDEX SBBD_SIT.IDX_CTRAN2021
  ENABLE VALIDATE);

ALTER TABLE SBBD_SIT.CTRANDD2021 ADD (
  PRIMARY KEY
...
ALTER TABLE SBBD_SIT.GLSUM2021 ADD (
  PRIMARY KEY
...
ALTER TABLE SBBD_SIT.SEGGLASUM2021 ADD (
  PRIMARY KEY
...
ALTER TABLE SBBD_SIT.SEGREPTRAN2021 ADD (
  PRIMARY KEY
...
ALTER TABLE SBBD_SIT.TRAN2021 ADD (
  CONSTRAINT PK_TRAN2021
  PRIMARY KEY
  (TRAN_ENTITY_NUM, TRAN_BRN_CODE, TRAN_DATE_OF_TRAN, TRAN_BATCH_NUMBER, TRAN_BATCH_SL_NUM)
  USING INDEX SBBD_SIT.IDX_TRAN2021_PK
  ENABLE VALIDATE);

ALTER TABLE SBBD_SIT.TRANADV2021 ADD (
  PRIMARY KEY
...
ALTER TABLE SBBD_SIT.TRANADVADDN2021 ADD (
  PRIMARY KEY
...
ALTER TABLE SBBD_SIT.TRANBAT2021 ADD (
  CONSTRAINT PK_TRANBAT2021
  PRIMARY KEY
  (TRANBAT_ENTITY_NUM, TRANBAT_BRN_CODE, TRANBAT_DATE_OF_TRAN, TRANBAT_BATCH_NUMBER)
  USING INDEX SBBD_SIT.IDX_TRANBAT2021_PK
  ENABLE VALIDATE);
